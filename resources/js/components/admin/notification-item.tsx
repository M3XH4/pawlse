...
import type { AdminNotification, AdminNotificationIcon } from '@/types/admin';

const iconStyles: Record<AdminNotificationIcon, string> = {
...
const icons: Record<AdminNotificationIcon, ReactNode> = {
...
export function AdminNotificationItem({
    ...
    return (
        <Link
            ...
            className={cn(
                'notification-item block px-5 py-3.5 transition-colors hover:bg-[#F8FAFC] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[#FF8A00]/50 dark:hover:bg-[#1E293B]',
                read && 'opacity-70',
            )}
        >
