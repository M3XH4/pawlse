...
export function DashboardNavLink({
    ...
    return (
        <Link
            ...
            className={cn(
                'group flex min-h-[44px] items-center gap-3 rounded-2xl px-4 py-3 text-sm font-semibold transition-[padding,gap,color,background-color,box-shadow] duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--dashboard-ring)]/50 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-offset-[#0F172A]',
                active
                    ? 'bg-gradient-to-r from-[var(--dashboard-primary-from)] to-[var(--dashboard-primary-to)] text-white shadow-[0_8px_24px_var(--dashboard-primary-shadow)]'
